...
import { CardCharacterInfoStyled, CardCharacterStyled } from "./CharacterCard.styles";
...
export const CardCharacter = ({ imageSrc, name, id, description, thumbnail }: CardCharacterProps) => {
